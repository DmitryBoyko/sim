...
-- History snapshot (optional: aggregated or raw copy for long-term history)
...
('phases', '{
  ...
  "transport_duration_sec": 300,
  "unload_duration_sec": 60,
  "return_duration_sec": 240
}'::jsonb),
('speed_weight', '{
  "v_min_kmh": 0.5,
  "v_max_kmh": 40,
...
('intervals', '{
  "generation_interval_sec": 10,
  "chart_minutes": 30
}'::jsonb),
('recognition', '{
  "window_speed_size": 100,
  "window_weight_size": 95,
